...
genoffset.o: $S/kern/genoffset.c
	${CC} -c ${CFLAGS:N-flto:N-fno-common:N-fsanitize=cfi} $S/kern/genoffset.c
...
genoffset_test.o: $S/kern/genoffset.c offset.inc
	${CC} -c ${CFLAGS:N-flto:N-fno-common:N-fsanitize=cfi} -DOFFSET_TEST \
...
genassym.o: $S/$M/$M/genassym.c  offset.inc
	${CC} -c ${CFLAGS:N-flto:N-fno-common:N-fsanitize=cfi} $S/$M/$M/genassym.c
